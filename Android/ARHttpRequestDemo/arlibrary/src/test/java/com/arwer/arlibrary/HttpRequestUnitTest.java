...
//    String urlString = "http://localhost:3000/download/Steven Levy：黑客——计算机革命的英雄 (25周年纪念版).mobi";//1.1M
            // 下载的文件最终保存的目录，仅目录
            String destPath = "/Users/long/temp/down/";
            // 下载的文件临时保存的文件路径，包含文件名的完整路径。（断点续传时使用）
            String tempPath = "/Users/long/temp/xxx.tmp";
...
//            String urlString1 = "http://localhost:3000/dev/mock/api/48e82320-efff-11e5-b524-8fc3522b1799/checkVersion";
            ...
            int taskTag = 1; //taskTag=taskName
            ...
            // Request Task2
            String urlString2 = "http://localhost:3000/dev/mock/api/48e82320-efff-11e5-b524-8fc3522b1799/checkVersion";
            taskTag = 2; //taskTag=taskName
